...
export class GradeFixaService {
  private apiUrl = 'https://api.piatividade7.duckdns.org/reservation/';
  private teachersUrl = 'https://api.piatividade7.duckdns.org/teacher/';
  private subjectsUrl = 'https://api.piatividade7.duckdns.org/subject/';
  private timesUrl = 'https://api.piatividade7.duckdns.org/time/';
  private roomsUrl = 'https://api.piatividade7.duckdns.org/rooms/';
  private coursesUrl = 'https://api.piatividade7.duckdns.org/course/';
